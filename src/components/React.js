...
<div className="container">
    <h1>React</h1>
        <p>React (also known as React.js or ReactJS) is a free and
        ...
        applications. However, React is only concerned with state management
        and rendering that state to the DOM, so creating React applications
        usually requires the use of additional libraries for routing, as well
        as certain client-side functionality.</p>
</div>
    )
}
